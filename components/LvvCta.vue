      ...
      <div class="py-10 px-6 bg-lvv-blue-600 rounded-3xl sm:py-16 sm:px-12 lg:p-16 lg:flex lg:items-center">
        <div class="lg:w-0 lg:flex-1 text-center lg:text-left">
          ...
          <p class="mt-4 max-w-3xl text-lg text-indigo-100">
            Soutenez la promotion et l'usage du vélo et de la marche à pied au quotidien dans l'agglomération de Morlaix Communauté, ainsi que le développement d'infrastructures cyclables continues et sécurisées en adhérant à l'association.
          </p>
        </div>
